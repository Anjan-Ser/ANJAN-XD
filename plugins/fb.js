...
╚┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅⚆\n`, contextInfo: { externalAdReply: {
     ...
     thumbnailUrl: "https://i.imgur.com/Xi87P5B.jpeg" }},},{ quoted: message });
    }
    );
...
await message.sendFromUrl(data.sdLink, {caption: "★𝐀𝐍𝐉𝐀𝐍-𝐗𝐃★"}, {quoted:message})
...
let title = final;
let {data} = await getJson(`https://api.vihangayt.asia/downloader/fb?url=${title}`)
await message.sendFromUrl(data.hdLink, {caption: "★𝐀𝐍𝐉𝐀𝐍-𝐗𝐃★"}, {quoted:message})
